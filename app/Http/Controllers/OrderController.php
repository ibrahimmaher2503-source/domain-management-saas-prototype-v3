...
final class OrderController extends Controller
{
    public function show(Request $request, Order $order)
    {
        ...
        $order->loadMissing(['registeredDomain', 'renewalDomain']);
        ...
        return Inertia::render('Orders/Show', ['order' => [
            'id' => $order->id, 'type' => $order->type, 'domain' => $order->domain, 'status' => $order->status, 'registration_period' => $order->registration_period,
