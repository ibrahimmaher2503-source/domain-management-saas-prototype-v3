...
Controllers stay thin. They authorize the authenticated user's resource access, validate input through request objects, call one application action, and return an Inertia response or redirect with safe status information.
